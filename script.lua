...
local all_modules = {
  ...
  },
  {
    ...
    dir = "kitty",
    build_reqs = "golang python3-devel harfbuzz-devel libpng-devel dbus-devel wayland-devel wayland-protocols-devel libxkbcommon-devel xxhash-devel simde-devel",
    core_deps = {}
  }
}
